...
public class PingPongRight {
    ...
    private final static int N_THREADS_MAX = 2;
    ...
    public static class PlayPingPongThread extends Thread {
        ...
        private final String mOutString; 
         ...
         */
        // TODO - You fill in here.
        private final SimpleSemaphore semList[] = new SimpleSemaphore[2];
        ...
        public PlayPingPongThread(String stringToPrint,
                                  ...
                                  int maxIterations) {
            // TODO - You fill in here.
        	mOutString = stringToPrint;
        	semList[FIRST_SEMA] = semaphoreOne;
        	semList[SECOND_SEMA] = semaphoreTwo;
        ...
        public void run() {
             ...
             */
//        	System.out.println(mOutString);
            // TODO - You fill in here.
    		try {
    			for (int i = 1; i <= mMaxLoopIterations; i++) {
         			acquire();
        			System.out.println(mOutString+"("+i+")");
        			release();
        			}
        		} finally {
        			mLatch.countDown();
        ...
        private void acquire() {
            // TODO fill in here
            semList[FIRST_SEMA].acquireUninterruptibly();
        	return;
        }
    ...
    public static void process(String startString, 
        ...
        // constructor call.
        mLatch = new CountDownLatch(N_THREADS_MAX);
