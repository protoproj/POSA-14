...
public class SimpleSemaphore {
	...
	private final Lock mPermitLock;
     ...
     */
    // TODO - you fill in here
	private final Condition mPermitAvail;
    ...
    public SimpleSemaphore(int permits, boolean fair) {
        ...
        // semantics.
    	mPermitLock = new ReentrantLock(fair);
    	mPermitAvail = mPermitLock.newCondition();
    	mPermits = permits;    	
    }
    ...
    public void acquireUninterruptibly() {
		...
		try {
			while (mPermits <= 0)
				mPermitAvail.awaitUninterruptibly();
			--mPermits;
		} finally {
			mPermitLock.unlock();
		  }
